// db-sqlite.js — file-based SQLite backend.
// Used automatically when no DATABASE_URL is set (e.g. local development).
// On Render's Free tier this file resets on every restart/redeploy/spin-down
// since Free instances don't support persistent disks — fine for local use,
// but for a real event on Render's free tier use db-postgres.js instead
// (db.js picks automatically based on DATABASE_URL).
